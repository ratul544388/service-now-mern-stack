...
const Sidebar = () => {
  ...
  return (
    <div className="relative">
      ...
      <aside
        className={cn(
          "min-w-[200px] bg-background border-r pt-16 sm:pt-0 sm:bg-transparent -inset-y-10 z-20 transition-all ease-in-out absolute sm:static -left-8 -translate-x-[calc(100%_+_100px)] sm:translate-x-0",
          open && "translate-x-0"
        )}
      >
